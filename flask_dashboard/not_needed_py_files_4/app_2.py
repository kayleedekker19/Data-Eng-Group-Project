...
def show_map():
    ...
    # HTML form for date and time selection with added styles and positioning
    form_html = '''
    <style>
        .form-container {
            position: absolute;
            top: 20px;
            left: 20px;
            width: 250px; /* Adjusted width to make the box smaller */
            padding: 15px; /* Adjusted padding to make the box smaller */
        ...
        label, input[type="date"], input[type="time"], input[type="submit"] {
            display: block;
            margin-top: 10px;
            margin-bottom: 10px;
        }
        label {
            margin-bottom: 5px;
            font-size: 16px; /* Adjusted font size to match the smaller box */
        }
        input[type="date"], input[type="time"] {
            width: 100%; /* Adjusted width to make the input boxes smaller */
            padding: 6px; /* Adjusted padding to make the input boxes smaller */
            border: 1px solid #ccc;
            border-radius: 5px;
            font-size: 14px; /* Adjusted font size to make the input boxes smaller */
        }
        input[type="submit"] {
            width: 100%;
            padding: 8px; /* Adjusted padding to match the smaller box */
