...
def main():
    json_filename = "/Users/kayleedekker/PycharmProjects/DataEngineeringProject/data_sources/airports_data.json"  # Make sure to provide the correct path to your JSON file
